...
void ONScripter::initSDL()
{
    ...
    if(accelerated_render_mode == false)
    {
        renderer = SDL_CreateRenderer(window, -1, SDL_RENDERER_SOFTWARE);
    }
    else if(accelerated_render_mode == true)
    {
    ...
    if (accelerated_render_mode == true)
    {
        utils::printInfo("Hardware Renderer\n");
    }
    else
    {
        utils::printInfo("Software Renderer\n");
    }
...
void ONScripter::set_accelerated_render_mode(bool s)
{
    accelerated_render_mode = s;
}
